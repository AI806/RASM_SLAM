...
#define __PYX_HAVE__dwa_evaluation
#define __PYX_HAVE_API__dwa_evaluation
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'dwa_evaluation' */
__PYX_EXTERN_C DL_IMPORT(int) c_dwa_evaluation(double *, double *, double *, double *, double *, double *, double *, double *, int, double, double); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_double = { "double", NULL, sizeof(double), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "dwa_evaluation"
extern int __pyx_module_is_main_dwa_evaluation;
int __pyx_module_is_main_dwa_evaluation = 0;

/* Implementation of 'dwa_evaluation' */
...
static const char __pyx_k_oSz[] = "oSz";
...
static const char __pyx_k_evalDB[] = "evalDB";
static const char __pyx_k_import[] = "__import__";
static const char __pyx_k_trajDB[] = "trajDB";
static const char __pyx_k_evalParam[] = "evalParam";
static const char __pyx_k_ValueError[] = "ValueError";
static const char __pyx_k_ImportError[] = "ImportError";
static const char __pyx_k_RuntimeError[] = "RuntimeError";
static const char __pyx_k_dwa_evaluation[] = "dwa_evaluation";
static const char __pyx_k_cline_in_traceback[] = "cline_in_traceback";
static const char __pyx_k_dwa_evaluation_pyx[] = "dwa_evaluation.pyx";
static const char __pyx_k_ndarray_is_not_C_contiguous[] = "ndarray is not C contiguous";
static const char __pyx_k_multiply_pyx_simple_cython_test[] = "\nmultiply.pyx\n\nsimple cython test of accessing a numpy array's data\n\nthe C function: c_multiply multiplies all the values in a 2-d array by a scalar, in place.\n\n";
...
static PyObject *__pyx_n_s_dwa_evaluation;
static PyObject *__pyx_kp_s_dwa_evaluation_pyx;
static PyObject *__pyx_n_s_evalDB;
...
static PyObject *__pyx_n_s_oSz;
static PyObject *__pyx_n_s_obst;
static PyObject *__pyx_n_s_range;
static PyObject *__pyx_n_s_state;
static PyObject *__pyx_n_s_test;
static PyObject *__pyx_n_s_trajDB;
static PyObject *__pyx_kp_u_unknown_dtype_code_in_numpy_pxd;
static PyObject *__pyx_pf_14dwa_evaluation_dwa_evaluation(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_evalDB, PyArrayObject *__pyx_v_trajDB, PyArrayObject *__pyx_v_X, PyArrayObject *__pyx_v_Vr, PyArrayObject *__pyx_v_goal, PyArrayObject *__pyx_v_obst, PyArrayObject *__pyx_v_model, PyArrayObject *__pyx_v_evalParam, double __pyx_v_R, double __pyx_v_dt); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_14dwa_evaluation_1dwa_evaluation(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_14dwa_evaluation_1dwa_evaluation = {"dwa_evaluation", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_14dwa_evaluation_1dwa_evaluation, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_14dwa_evaluation_1dwa_evaluation(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_evalDB = 0;
  PyArrayObject *__pyx_v_trajDB = 0;
  PyArrayObject *__pyx_v_X = 0;
  PyArrayObject *__pyx_v_Vr = 0;
  PyArrayObject *__pyx_v_goal = 0;
  PyArrayObject *__pyx_v_obst = 0;
  PyArrayObject *__pyx_v_model = 0;
  PyArrayObject *__pyx_v_evalParam = 0;
  double __pyx_v_R;
  double __pyx_v_dt;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("dwa_evaluation (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_evalDB,&__pyx_n_s_trajDB,&__pyx_n_s_X,&__pyx_n_s_Vr,&__pyx_n_s_goal,&__pyx_n_s_obst,&__pyx_n_s_model,&__pyx_n_s_evalParam,&__pyx_n_s_R,&__pyx_n_s_dt,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_evalDB)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_trajDB)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("dwa_evaluation", 1, 10, 10, 1); __PYX_ERR(0, 22, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_X)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("dwa_evaluation", 1, 10, 10, 2); __PYX_ERR(0, 22, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_Vr)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("dwa_evaluation", 1, 10, 10, 3); __PYX_ERR(0, 22, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_goal)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("dwa_evaluation", 1, 10, 10, 4); __PYX_ERR(0, 22, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_obst)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("dwa_evaluation", 1, 10, 10, 5); __PYX_ERR(0, 22, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_model)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("dwa_evaluation", 1, 10, 10, 6); __PYX_ERR(0, 22, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  7:
        if (likely((values[7] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_evalParam)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("dwa_evaluation", 1, 10, 10, 7); __PYX_ERR(0, 22, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  8:
        if (likely((values[8] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_R)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("dwa_evaluation", 1, 10, 10, 8); __PYX_ERR(0, 22, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  9:
        if (likely((values[9] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_dt)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("dwa_evaluation", 1, 10, 10, 9); __PYX_ERR(0, 22, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "dwa_evaluation") < 0)) __PYX_ERR(0, 22, __pyx_L3_error)
      }
    ...
    __pyx_v_evalDB = ((PyArrayObject *)values[0]);
    __pyx_v_trajDB = ((PyArrayObject *)values[1]);
    __pyx_v_X = ((PyArrayObject *)values[2]);
    __pyx_v_Vr = ((PyArrayObject *)values[3]);
    __pyx_v_goal = ((PyArrayObject *)values[4]);
    __pyx_v_obst = ((PyArrayObject *)values[5]);
    __pyx_v_model = ((PyArrayObject *)values[6]);
    __pyx_v_evalParam = ((PyArrayObject *)values[7]);
    __pyx_v_R = __pyx_PyFloat_AsDouble(values[8]); if (unlikely((__pyx_v_R == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 26, __pyx_L3_error)
    __pyx_v_dt = __pyx_PyFloat_AsDouble(values[9]); if (unlikely((__pyx_v_dt == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 26, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("dwa_evaluation", 1, 10, 10, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 22, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("dwa_evaluation.dwa_evaluation", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_evalDB), __pyx_ptype_5numpy_ndarray, 0, "evalDB", 0))) __PYX_ERR(0, 22, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_trajDB), __pyx_ptype_5numpy_ndarray, 0, "trajDB", 0))) __PYX_ERR(0, 22, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_X), __pyx_ptype_5numpy_ndarray, 0, "X", 0))) __PYX_ERR(0, 23, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_Vr), __pyx_ptype_5numpy_ndarray, 0, "Vr", 0))) __PYX_ERR(0, 23, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_goal), __pyx_ptype_5numpy_ndarray, 0, "goal", 0))) __PYX_ERR(0, 24, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_obst), __pyx_ptype_5numpy_ndarray, 0, "obst", 0))) __PYX_ERR(0, 24, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_model), __pyx_ptype_5numpy_ndarray, 0, "model", 0))) __PYX_ERR(0, 25, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_evalParam), __pyx_ptype_5numpy_ndarray, 0, "evalParam", 0))) __PYX_ERR(0, 25, __pyx_L1_error)
  __pyx_r = __pyx_pf_14dwa_evaluation_dwa_evaluation(__pyx_self, __pyx_v_evalDB, __pyx_v_trajDB, __pyx_v_X, __pyx_v_Vr, __pyx_v_goal, __pyx_v_obst, __pyx_v_model, __pyx_v_evalParam, __pyx_v_R, __pyx_v_dt);
...
static PyObject *__pyx_pf_14dwa_evaluation_dwa_evaluation(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_evalDB, PyArrayObject *__pyx_v_trajDB, PyArrayObject *__pyx_v_X, PyArrayObject *__pyx_v_Vr, PyArrayObject *__pyx_v_goal, PyArrayObject *__pyx_v_obst, PyArrayObject *__pyx_v_model, PyArrayObject *__pyx_v_evalParam, double __pyx_v_R, double __pyx_v_dt) {
  ...
  __Pyx_LocalBuf_ND __pyx_pybuffernd_evalDB;
  __Pyx_Buffer __pyx_pybuffer_evalDB;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_evalParam;
  __Pyx_Buffer __pyx_pybuffer_evalParam;
  ...
  __Pyx_LocalBuf_ND __pyx_pybuffernd_obst;
  __Pyx_Buffer __pyx_pybuffer_obst;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_trajDB;
  __Pyx_Buffer __pyx_pybuffer_trajDB;
  ...
  __Pyx_RefNannySetupContext("dwa_evaluation", 0);
  __pyx_pybuffer_evalDB.pybuffer.buf = NULL;
  __pyx_pybuffer_evalDB.refcount = 0;
  __pyx_pybuffernd_evalDB.data = NULL;
  __pyx_pybuffernd_evalDB.rcbuffer = &__pyx_pybuffer_evalDB;
  __pyx_pybuffer_trajDB.pybuffer.buf = NULL;
  __pyx_pybuffer_trajDB.refcount = 0;
  __pyx_pybuffernd_trajDB.data = NULL;
  __pyx_pybuffernd_trajDB.rcbuffer = &__pyx_pybuffer_trajDB;
  ...
  __pyx_pybuffer_obst.pybuffer.buf = NULL;
  __pyx_pybuffer_obst.refcount = 0;
  __pyx_pybuffernd_obst.data = NULL;
  __pyx_pybuffernd_obst.rcbuffer = &__pyx_pybuffer_obst;
  ...
  __pyx_pybuffer_evalParam.pybuffer.buf = NULL;
  __pyx_pybuffer_evalParam.refcount = 0;
  __pyx_pybuffernd_evalParam.data = NULL;
  __pyx_pybuffernd_evalParam.rcbuffer = &__pyx_pybuffer_evalParam;
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_evalDB.rcbuffer->pybuffer, (PyObject*)__pyx_v_evalDB, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 22, __pyx_L1_error)
  }
  __pyx_pybuffernd_evalDB.diminfo[0].strides = __pyx_pybuffernd_evalDB.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_evalDB.diminfo[0].shape = __pyx_pybuffernd_evalDB.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_evalDB.diminfo[1].strides = __pyx_pybuffernd_evalDB.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_evalDB.diminfo[1].shape = __pyx_pybuffernd_evalDB.rcbuffer->pybuffer.shape[1];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_trajDB.rcbuffer->pybuffer, (PyObject*)__pyx_v_trajDB, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 22, __pyx_L1_error)
  }
  __pyx_pybuffernd_trajDB.diminfo[0].strides = __pyx_pybuffernd_trajDB.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_trajDB.diminfo[0].shape = __pyx_pybuffernd_trajDB.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_trajDB.diminfo[1].strides = __pyx_pybuffernd_trajDB.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_trajDB.diminfo[1].shape = __pyx_pybuffernd_trajDB.rcbuffer->pybuffer.shape[1];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_X.rcbuffer->pybuffer, (PyObject*)__pyx_v_X, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 22, __pyx_L1_error)
  }
  __pyx_pybuffernd_X.diminfo[0].strides = __pyx_pybuffernd_X.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_X.diminfo[0].shape = __pyx_pybuffernd_X.rcbuffer->pybuffer.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_Vr.rcbuffer->pybuffer, (PyObject*)__pyx_v_Vr, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 22, __pyx_L1_error)
  }
  __pyx_pybuffernd_Vr.diminfo[0].strides = __pyx_pybuffernd_Vr.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_Vr.diminfo[0].shape = __pyx_pybuffernd_Vr.rcbuffer->pybuffer.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_goal.rcbuffer->pybuffer, (PyObject*)__pyx_v_goal, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 22, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_obst.rcbuffer->pybuffer, (PyObject*)__pyx_v_obst, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 22, __pyx_L1_error)
  }
  __pyx_pybuffernd_obst.diminfo[0].strides = __pyx_pybuffernd_obst.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_obst.diminfo[0].shape = __pyx_pybuffernd_obst.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_obst.diminfo[1].strides = __pyx_pybuffernd_obst.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_obst.diminfo[1].shape = __pyx_pybuffernd_obst.rcbuffer->pybuffer.shape[1];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_model.rcbuffer->pybuffer, (PyObject*)__pyx_v_model, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 22, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_evalParam.rcbuffer->pybuffer, (PyObject*)__pyx_v_evalParam, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 22, __pyx_L1_error)
  }
  __pyx_pybuffernd_evalParam.diminfo[0].strides = __pyx_pybuffernd_evalParam.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_evalParam.diminfo[0].shape = __pyx_pybuffernd_evalParam.rcbuffer->pybuffer.shape[0];

  /* "dwa_evaluation.pyx":29
 * 
 *     cdef int oSz
 *     oSz = obst.shape[0]             # <<<<<<<<<<<<<<
 ...
 * 
 */
  __pyx_v_oSz = (__pyx_v_obst->dimensions[0]);

  /* "dwa_evaluation.pyx":30
 *     cdef int oSz
 *     oSz = obst.shape[0]
 *     state = c_dwa_evaluation (&evalDB[0, 0], &trajDB[0, 0], &X[0], &Vr[0], &goal[0], &obst[0, 0], &model[0], &evalParam[0], oSz, R, dt)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_10 = 0;
  __pyx_t_11 = 0;
  __pyx_v_state = c_dwa_evaluation((&(*__Pyx_BufPtrCContig2d(double *, __pyx_pybuffernd_evalDB.rcbuffer->pybuffer.buf, __pyx_t_1, __pyx_pybuffernd_evalDB.diminfo[0].strides, __pyx_t_2, __pyx_pybuffernd_evalDB.diminfo[1].strides))), (&(*__Pyx_BufPtrCContig2d(double *, __pyx_pybuffernd_trajDB.rcbuffer->pybuffer.buf, __pyx_t_3, __pyx_pybuffernd_trajDB.diminfo[0].strides, __pyx_t_4, __pyx_pybuffernd_trajDB.diminfo[1].strides))), (&(*__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_X.rcbuffer->pybuffer.buf, __pyx_t_5, __pyx_pybuffernd_X.diminfo[0].strides))), (&(*__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_Vr.rcbuffer->pybuffer.buf, __pyx_t_6, __pyx_pybuffernd_Vr.diminfo[0].strides))), (&(*__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_goal.rcbuffer->pybuffer.buf, __pyx_t_7, __pyx_pybuffernd_goal.diminfo[0].strides))), (&(*__Pyx_BufPtrCContig2d(double *, __pyx_pybuffernd_obst.rcbuffer->pybuffer.buf, __pyx_t_8, __pyx_pybuffernd_obst.diminfo[0].strides, __pyx_t_9, __pyx_pybuffernd_obst.diminfo[1].strides))), (&(*__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_model.rcbuffer->pybuffer.buf, __pyx_t_10, __pyx_pybuffernd_model.diminfo[0].strides))), (&(*__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_evalParam.rcbuffer->pybuffer.buf, __pyx_t_11, __pyx_pybuffernd_evalParam.diminfo[0].strides))), __pyx_v_oSz, __pyx_v_R, __pyx_v_dt);

  /* "dwa_evaluation.pyx":32
 *     state = c_dwa_evaluation (&evalDB[0, 0], &trajDB[0, 0], &X[0], &Vr[0], &goal[0], &obst[0, 0], &model[0], &evalParam[0], oSz, R, dt)
 * 
 *     return state             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_12 = __Pyx_PyInt_From_int(__pyx_v_state); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 32, __pyx_L1_error)
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_evalDB.rcbuffer->pybuffer);
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_evalParam.rcbuffer->pybuffer);
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_obst.rcbuffer->pybuffer);
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_trajDB.rcbuffer->pybuffer);
...
static int __pyx_pymod_exec_dwa_evaluation(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_dwa_evaluation},
  {0, NULL}
};
#endif
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    "dwa_evaluation",
    __pyx_k_multiply_pyx_simple_cython_test, /* m_doc */
  #if CYTHON_PEP489_MULTI_PHASE_INIT
    0, /* m_size */
  #else
    -1, /* m_size */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_dwa_evaluation, __pyx_k_dwa_evaluation, sizeof(__pyx_k_dwa_evaluation), 0, 0, 1, 1},
  {&__pyx_kp_s_dwa_evaluation_pyx, __pyx_k_dwa_evaluation_pyx, sizeof(__pyx_k_dwa_evaluation_pyx), 0, 0, 1, 0},
  {&__pyx_n_s_evalDB, __pyx_k_evalDB, sizeof(__pyx_k_evalDB), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_oSz, __pyx_k_oSz, sizeof(__pyx_k_oSz), 0, 0, 1, 1},
  {&__pyx_n_s_obst, __pyx_k_obst, sizeof(__pyx_k_obst), 0, 0, 1, 1},
  {&__pyx_n_s_range, __pyx_k_range, sizeof(__pyx_k_range), 0, 0, 1, 1},
  {&__pyx_n_s_state, __pyx_k_state, sizeof(__pyx_k_state), 0, 0, 1, 1},
  {&__pyx_n_s_test, __pyx_k_test, sizeof(__pyx_k_test), 0, 0, 1, 1},
  {&__pyx_n_s_trajDB, __pyx_k_trajDB, sizeof(__pyx_k_trajDB), 0, 0, 1, 1},
 ...
 *     np.ndarray[double, ndim=1, mode="c"] goal not None, np.ndarray[double, ndim=2, mode="c"] obst not None,
 */
  __pyx_tuple__8 = PyTuple_Pack(12, __pyx_n_s_evalDB, __pyx_n_s_trajDB, __pyx_n_s_X, __pyx_n_s_Vr, __pyx_n_s_goal, __pyx_n_s_obst, __pyx_n_s_model, __pyx_n_s_evalParam, __pyx_n_s_R, __pyx_n_s_dt, __pyx_n_s_oSz, __pyx_n_s_state); if (unlikely(!__pyx_tuple__8)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__8);
  __Pyx_GIVEREF(__pyx_tuple__8);
  __pyx_codeobj__9 = (PyObject*)__Pyx_PyCode_New(10, 0, 12, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__8, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_dwa_evaluation_pyx, __pyx_n_s_dwa_evaluation, 22, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__9)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initdwa_evaluation(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initdwa_evaluation(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_dwa_evaluation(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_dwa_evaluation(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_dwa_evaluation(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'dwa_evaluation' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_dwa_evaluation(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("dwa_evaluation", __pyx_methods, __pyx_k_multiply_pyx_simple_cython_test, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_dwa_evaluation) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "dwa_evaluation")) {
      if (unlikely(PyDict_SetItemString(modules, "dwa_evaluation", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     np.ndarray[double, ndim=1, mode="c"] goal not None, np.ndarray[double, ndim=2, mode="c"] obst not None,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_14dwa_evaluation_1dwa_evaluation, NULL, __pyx_n_s_dwa_evaluation); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_dwa_evaluation, __pyx_t_1) < 0) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "dwa_evaluation.pyx":1
 * """             # <<<<<<<<<<<<<<
 * multiply.pyx
 * 
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init dwa_evaluation", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init dwa_evaluation");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
