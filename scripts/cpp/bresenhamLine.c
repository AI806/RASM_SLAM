...
#define __PYX_HAVE__bresenhamLine
#define __PYX_HAVE_API__bresenhamLine
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'bresenhamLine' */
__PYX_EXTERN_C DL_IMPORT(int) c_bresenhamLine(double *, int *, int *, int *, int, int, int, double, double, int, int); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_double = { "double", NULL, sizeof(double), { 0 }, 0, 'R', 0, 0 };
static __Pyx_TypeInfo __Pyx_TypeInfo_int = { "int", NULL, sizeof(int), { 0 }, 0, IS_UNSIGNED(int) ? 'U' : 'I', IS_UNSIGNED(int), 0 };
#define __Pyx_MODULE_NAME "bresenhamLine"
extern int __pyx_module_is_main_bresenhamLine;
int __pyx_module_is_main_bresenhamLine = 0;

/* Implementation of 'bresenhamLine' */
...
static const char __pyx_k_pointCnt[] = "pointCnt";
static const char __pyx_k_startPos[] = "startPos";
static const char __pyx_k_mapMatrix[] = "mapMatrix";
static const char __pyx_k_updateOcc[] = "updateOcc";
static const char __pyx_k_ValueError[] = "ValueError";
static const char __pyx_k_updateFree[] = "updateFree";
static const char __pyx_k_ImportError[] = "ImportError";
static const char __pyx_k_RuntimeError[] = "RuntimeError";
static const char __pyx_k_bresenhamLine[] = "bresenhamLine";
static const char __pyx_k_mapMatrixIndex[] = "mapMatrixIndex";
static const char __pyx_k_currMarkOccIndex[] = "currMarkOccIndex";
static const char __pyx_k_bresenhamLine_pyx[] = "bresenhamLine.pyx";
static const char __pyx_k_currMarkFreeIndex[] = "currMarkFreeIndex";
...
static PyObject *__pyx_n_s_bresenhamLine;
static PyObject *__pyx_kp_s_bresenhamLine_pyx;
static PyObject *__pyx_n_s_cline_in_traceback;
static PyObject *__pyx_n_s_currMarkFreeIndex;
static PyObject *__pyx_n_s_currMarkOccIndex;
static PyObject *__pyx_n_s_endPos;
static PyObject *__pyx_n_s_import;
static PyObject *__pyx_n_s_main;
static PyObject *__pyx_n_s_mapMatrix;
static PyObject *__pyx_n_s_mapMatrixIndex;
...
static PyObject *__pyx_n_s_pointCnt;
static PyObject *__pyx_n_s_range;
static PyObject *__pyx_n_s_startPos;
static PyObject *__pyx_n_s_state;
static PyObject *__pyx_n_s_test;
static PyObject *__pyx_kp_u_unknown_dtype_code_in_numpy_pxd;
static PyObject *__pyx_n_s_updateFree;
static PyObject *__pyx_n_s_updateOcc;
static PyObject *__pyx_n_s_xSize;
static PyObject *__pyx_n_s_ySize;
static PyObject *__pyx_pf_13bresenhamLine_bresenhamLine(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_mapMatrix, PyArrayObject *__pyx_v_mapMatrixIndex, PyArrayObject *__pyx_v_startPos, PyArrayObject *__pyx_v_endPos, double __pyx_v_updateFree, double __pyx_v_updateOcc, int __pyx_v_currMarkFreeIndex, int __pyx_v_currMarkOccIndex); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_13bresenhamLine_1bresenhamLine(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_13bresenhamLine_bresenhamLine[] = "\n    multiply (arr, value)\n\n    Takes a numpy arry as input, and multiplies each elemetn by value, in place\n\n    param: array -- a 2-d numpy array of np.float64\n    param: value -- a number that will be multiplied by each element in the array\n\n    ";
static PyMethodDef __pyx_mdef_13bresenhamLine_1bresenhamLine = {"bresenhamLine", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_13bresenhamLine_1bresenhamLine, METH_VARARGS|METH_KEYWORDS, __pyx_doc_13bresenhamLine_bresenhamLine};
static PyObject *__pyx_pw_13bresenhamLine_1bresenhamLine(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_mapMatrix = 0;
  PyArrayObject *__pyx_v_mapMatrixIndex = 0;
  PyArrayObject *__pyx_v_startPos = 0;
  PyArrayObject *__pyx_v_endPos = 0;
  double __pyx_v_updateFree;
  double __pyx_v_updateOcc;
  int __pyx_v_currMarkFreeIndex;
  int __pyx_v_currMarkOccIndex;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("bresenhamLine (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_mapMatrix,&__pyx_n_s_mapMatrixIndex,&__pyx_n_s_startPos,&__pyx_n_s_endPos,&__pyx_n_s_updateFree,&__pyx_n_s_updateOcc,&__pyx_n_s_currMarkFreeIndex,&__pyx_n_s_currMarkOccIndex,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_mapMatrix)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_mapMatrixIndex)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("bresenhamLine", 1, 8, 8, 1); __PYX_ERR(0, 21, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_startPos)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("bresenhamLine", 1, 8, 8, 2); __PYX_ERR(0, 21, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_endPos)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("bresenhamLine", 1, 8, 8, 3); __PYX_ERR(0, 21, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_updateFree)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("bresenhamLine", 1, 8, 8, 4); __PYX_ERR(0, 21, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_updateOcc)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("bresenhamLine", 1, 8, 8, 5); __PYX_ERR(0, 21, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_currMarkFreeIndex)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("bresenhamLine", 1, 8, 8, 6); __PYX_ERR(0, 21, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  7:
        if (likely((values[7] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_currMarkOccIndex)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("bresenhamLine", 1, 8, 8, 7); __PYX_ERR(0, 21, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "bresenhamLine") < 0)) __PYX_ERR(0, 21, __pyx_L3_error)
      }
    ...
    __pyx_v_mapMatrix = ((PyArrayObject *)values[0]);
    __pyx_v_mapMatrixIndex = ((PyArrayObject *)values[1]);
    __pyx_v_startPos = ((PyArrayObject *)values[2]);
    __pyx_v_endPos = ((PyArrayObject *)values[3]);
    __pyx_v_updateFree = __pyx_PyFloat_AsDouble(values[4]); if (unlikely((__pyx_v_updateFree == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 23, __pyx_L3_error)
    __pyx_v_updateOcc = __pyx_PyFloat_AsDouble(values[5]); if (unlikely((__pyx_v_updateOcc == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 23, __pyx_L3_error)
    __pyx_v_currMarkFreeIndex = __Pyx_PyInt_As_int(values[6]); if (unlikely((__pyx_v_currMarkFreeIndex == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 23, __pyx_L3_error)
    __pyx_v_currMarkOccIndex = __Pyx_PyInt_As_int(values[7]); if (unlikely((__pyx_v_currMarkOccIndex == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 23, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("bresenhamLine", 1, 8, 8, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 21, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("bresenhamLine.bresenhamLine", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_mapMatrix), __pyx_ptype_5numpy_ndarray, 0, "mapMatrix", 0))) __PYX_ERR(0, 21, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_mapMatrixIndex), __pyx_ptype_5numpy_ndarray, 0, "mapMatrixIndex", 0))) __PYX_ERR(0, 21, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_startPos), __pyx_ptype_5numpy_ndarray, 0, "startPos", 0))) __PYX_ERR(0, 22, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_endPos), __pyx_ptype_5numpy_ndarray, 0, "endPos", 0))) __PYX_ERR(0, 23, __pyx_L1_error)
  __pyx_r = __pyx_pf_13bresenhamLine_bresenhamLine(__pyx_self, __pyx_v_mapMatrix, __pyx_v_mapMatrixIndex, __pyx_v_startPos, __pyx_v_endPos, __pyx_v_updateFree, __pyx_v_updateOcc, __pyx_v_currMarkFreeIndex, __pyx_v_currMarkOccIndex);
...
static PyObject *__pyx_pf_13bresenhamLine_bresenhamLine(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_mapMatrix, PyArrayObject *__pyx_v_mapMatrixIndex, PyArrayObject *__pyx_v_startPos, PyArrayObject *__pyx_v_endPos, double __pyx_v_updateFree, double __pyx_v_updateOcc, int __pyx_v_currMarkFreeIndex, int __pyx_v_currMarkOccIndex) {
  int __pyx_v_xSize;
  int __pyx_v_ySize;
  int __pyx_v_pointCnt;
  int __pyx_v_state;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_endPos;
  __Pyx_Buffer __pyx_pybuffer_endPos;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_mapMatrix;
  __Pyx_Buffer __pyx_pybuffer_mapMatrix;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_mapMatrixIndex;
  __Pyx_Buffer __pyx_pybuffer_mapMatrixIndex;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_startPos;
  __Pyx_Buffer __pyx_pybuffer_startPos;
  ...
  __Pyx_RefNannySetupContext("bresenhamLine", 0);
  ...
  __pyx_pybuffer_mapMatrixIndex.pybuffer.buf = NULL;
  __pyx_pybuffer_mapMatrixIndex.refcount = 0;
  __pyx_pybuffernd_mapMatrixIndex.data = NULL;
  __pyx_pybuffernd_mapMatrixIndex.rcbuffer = &__pyx_pybuffer_mapMatrixIndex;
  __pyx_pybuffer_startPos.pybuffer.buf = NULL;
  __pyx_pybuffer_startPos.refcount = 0;
  __pyx_pybuffernd_startPos.data = NULL;
  __pyx_pybuffernd_startPos.rcbuffer = &__pyx_pybuffer_startPos;
  __pyx_pybuffer_endPos.pybuffer.buf = NULL;
  __pyx_pybuffer_endPos.refcount = 0;
  __pyx_pybuffernd_endPos.data = NULL;
  __pyx_pybuffernd_endPos.rcbuffer = &__pyx_pybuffer_endPos;
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_mapMatrix.rcbuffer->pybuffer, (PyObject*)__pyx_v_mapMatrix, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 21, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_mapMatrixIndex.rcbuffer->pybuffer, (PyObject*)__pyx_v_mapMatrixIndex, &__Pyx_TypeInfo_int, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 21, __pyx_L1_error)
  }
  __pyx_pybuffernd_mapMatrixIndex.diminfo[0].strides = __pyx_pybuffernd_mapMatrixIndex.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_mapMatrixIndex.diminfo[0].shape = __pyx_pybuffernd_mapMatrixIndex.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_mapMatrixIndex.diminfo[1].strides = __pyx_pybuffernd_mapMatrixIndex.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_mapMatrixIndex.diminfo[1].shape = __pyx_pybuffernd_mapMatrixIndex.rcbuffer->pybuffer.shape[1];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_startPos.rcbuffer->pybuffer, (PyObject*)__pyx_v_startPos, &__Pyx_TypeInfo_int, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 21, __pyx_L1_error)
  }
  __pyx_pybuffernd_startPos.diminfo[0].strides = __pyx_pybuffernd_startPos.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_startPos.diminfo[0].shape = __pyx_pybuffernd_startPos.rcbuffer->pybuffer.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_endPos.rcbuffer->pybuffer, (PyObject*)__pyx_v_endPos, &__Pyx_TypeInfo_int, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 21, __pyx_L1_error)
  }
  __pyx_pybuffernd_endPos.diminfo[0].strides = __pyx_pybuffernd_endPos.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_endPos.diminfo[0].shape = __pyx_pybuffernd_endPos.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_endPos.diminfo[1].strides = __pyx_pybuffernd_endPos.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_endPos.diminfo[1].shape = __pyx_pybuffernd_endPos.rcbuffer->pybuffer.shape[1];

  /* "bresenhamLine.pyx":35
 ...
 */
  __pyx_t_1 = (__pyx_v_mapMatrix->dimensions[0]);
  __pyx_t_2 = (__pyx_v_mapMatrix->dimensions[1]);
  __pyx_t_3 = (__pyx_v_endPos->dimensions[0]);
  __pyx_v_xSize = __pyx_t_1;
  __pyx_v_ySize = __pyx_t_2;
  __pyx_v_pointCnt = __pyx_t_3;

  /* "bresenhamLine.pyx":37
 *     xSize, ySize, pointCnt = mapMatrix.shape[0], mapMatrix.shape[1], endPos.shape[0]
 * 
 *     state = c_bresenhamLine (&mapMatrix[0,0], &mapMatrixIndex[0,0], &startPos[0], &endPos[0,0], xSize, ySize, pointCnt, updateFree, updateOcc, currMarkFreeIndex, currMarkOccIndex)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_9 = 0;
  __pyx_t_10 = 0;
  __pyx_v_state = c_bresenhamLine((&(*__Pyx_BufPtrCContig2d(double *, __pyx_pybuffernd_mapMatrix.rcbuffer->pybuffer.buf, __pyx_t_4, __pyx_pybuffernd_mapMatrix.diminfo[0].strides, __pyx_t_5, __pyx_pybuffernd_mapMatrix.diminfo[1].strides))), (&(*__Pyx_BufPtrCContig2d(int *, __pyx_pybuffernd_mapMatrixIndex.rcbuffer->pybuffer.buf, __pyx_t_6, __pyx_pybuffernd_mapMatrixIndex.diminfo[0].strides, __pyx_t_7, __pyx_pybuffernd_mapMatrixIndex.diminfo[1].strides))), (&(*__Pyx_BufPtrCContig1d(int *, __pyx_pybuffernd_startPos.rcbuffer->pybuffer.buf, __pyx_t_8, __pyx_pybuffernd_startPos.diminfo[0].strides))), (&(*__Pyx_BufPtrCContig2d(int *, __pyx_pybuffernd_endPos.rcbuffer->pybuffer.buf, __pyx_t_9, __pyx_pybuffernd_endPos.diminfo[0].strides, __pyx_t_10, __pyx_pybuffernd_endPos.diminfo[1].strides))), __pyx_v_xSize, __pyx_v_ySize, __pyx_v_pointCnt, __pyx_v_updateFree, __pyx_v_updateOcc, __pyx_v_currMarkFreeIndex, __pyx_v_currMarkOccIndex);

  /* "bresenhamLine.pyx":39
 *     state = c_bresenhamLine (&mapMatrix[0,0], &mapMatrixIndex[0,0], &startPos[0], &endPos[0,0], xSize, ySize, pointCnt, updateFree, updateOcc, currMarkFreeIndex, currMarkOccIndex)
 * 
 *     return state             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_11 = __Pyx_PyInt_From_int(__pyx_v_state); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 39, __pyx_L1_error)
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_endPos.rcbuffer->pybuffer);
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_mapMatrix.rcbuffer->pybuffer);
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_mapMatrixIndex.rcbuffer->pybuffer);
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_startPos.rcbuffer->pybuffer);
...
static int __pyx_pymod_exec_bresenhamLine(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_bresenhamLine},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_bresenhamLine, __pyx_k_bresenhamLine, sizeof(__pyx_k_bresenhamLine), 0, 0, 1, 1},
  {&__pyx_kp_s_bresenhamLine_pyx, __pyx_k_bresenhamLine_pyx, sizeof(__pyx_k_bresenhamLine_pyx), 0, 0, 1, 0},
  {&__pyx_n_s_cline_in_traceback, __pyx_k_cline_in_traceback, sizeof(__pyx_k_cline_in_traceback), 0, 0, 1, 1},
  {&__pyx_n_s_currMarkFreeIndex, __pyx_k_currMarkFreeIndex, sizeof(__pyx_k_currMarkFreeIndex), 0, 0, 1, 1},
  {&__pyx_n_s_currMarkOccIndex, __pyx_k_currMarkOccIndex, sizeof(__pyx_k_currMarkOccIndex), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_mapMatrixIndex, __pyx_k_mapMatrixIndex, sizeof(__pyx_k_mapMatrixIndex), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_pointCnt, __pyx_k_pointCnt, sizeof(__pyx_k_pointCnt), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_updateFree, __pyx_k_updateFree, sizeof(__pyx_k_updateFree), 0, 0, 1, 1},
  {&__pyx_n_s_updateOcc, __pyx_k_updateOcc, sizeof(__pyx_k_updateOcc), 0, 0, 1, 1},
 ...
 *     np.ndarray[int, ndim=2, mode="c"] endPos not None, double updateFree, double updateOcc, int currMarkFreeIndex, int currMarkOccIndex):
 */
  __pyx_tuple__8 = PyTuple_Pack(12, __pyx_n_s_mapMatrix, __pyx_n_s_mapMatrixIndex, __pyx_n_s_startPos, __pyx_n_s_endPos, __pyx_n_s_updateFree, __pyx_n_s_updateOcc, __pyx_n_s_currMarkFreeIndex, __pyx_n_s_currMarkOccIndex, __pyx_n_s_xSize, __pyx_n_s_ySize, __pyx_n_s_pointCnt, __pyx_n_s_state); if (unlikely(!__pyx_tuple__8)) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__8);
  __Pyx_GIVEREF(__pyx_tuple__8);
  __pyx_codeobj__9 = (PyObject*)__Pyx_PyCode_New(8, 0, 12, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__8, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_bresenhamLine_pyx, __pyx_n_s_bresenhamLine, 21, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__9)) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initbresenhamLine(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initbresenhamLine(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_bresenhamLine(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_bresenhamLine(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_bresenhamLine(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'bresenhamLine' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_bresenhamLine(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("bresenhamLine", __pyx_methods, __pyx_k_multiply_pyx_simple_cython_test, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_bresenhamLine) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "bresenhamLine")) {
      if (unlikely(PyDict_SetItemString(modules, "bresenhamLine", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     np.ndarray[int, ndim=2, mode="c"] endPos not None, double updateFree, double updateOcc, int currMarkFreeIndex, int currMarkOccIndex):
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_13bresenhamLine_1bresenhamLine, NULL, __pyx_n_s_bresenhamLine); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_bresenhamLine, __pyx_t_1) < 0) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init bresenhamLine", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init bresenhamLine");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
