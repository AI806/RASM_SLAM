...
#define __PYX_HAVE__state_refine
#define __PYX_HAVE_API__state_refine
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'state_refine' */
__PYX_EXTERN_C DL_IMPORT(double) c_state_refine(double *, double *, double *, double *, double *, double *, double *, int); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_double = { "double", NULL, sizeof(double), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "state_refine"
extern int __pyx_module_is_main_state_refine;
int __pyx_module_is_main_state_refine = 0;

/* Implementation of 'state_refine' */
...
static const char __pyx_k_obsCnt[] = "obsCnt";
static const char __pyx_k_beamParam[] = "beamParam";
static const char __pyx_k_mapMatrix[] = "mapMatrix";
static const char __pyx_k_ValueError[] = "ValueError";
static const char __pyx_k_optRobotSt[] = "optRobotSt";
static const char __pyx_k_robotState[] = "robotState";
static const char __pyx_k_ImportError[] = "ImportError";
static const char __pyx_k_RuntimeError[] = "RuntimeError";
static const char __pyx_k_state_refine[] = "state_refine";
static const char __pyx_k_obstaclesToRobot[] = "obstaclesToRobot";
static const char __pyx_k_state_refine_pyx[] = "state_refine.pyx";
...
static PyObject *__pyx_n_s_beamParam;
static PyObject *__pyx_n_s_cline_in_traceback;
static PyObject *__pyx_n_s_import;
static PyObject *__pyx_n_s_main;
static PyObject *__pyx_n_s_mapMatrix;
...
static PyObject *__pyx_n_s_obsCnt;
static PyObject *__pyx_n_s_obstaclesToRobot;
static PyObject *__pyx_n_s_optRobotSt;
static PyObject *__pyx_n_s_range;
static PyObject *__pyx_n_s_robotState;
static PyObject *__pyx_n_s_score;
static PyObject *__pyx_n_s_state_refine;
static PyObject *__pyx_kp_s_state_refine_pyx;
static PyObject *__pyx_n_s_test;
static PyObject *__pyx_kp_u_unknown_dtype_code_in_numpy_pxd;
static PyObject *__pyx_n_s_var;
static PyObject *__pyx_pf_12state_refine_state_refine(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_optRobotSt, PyArrayObject *__pyx_v_obs, PyArrayObject *__pyx_v_mapMatrix, PyArrayObject *__pyx_v_robotState, PyArrayObject *__pyx_v_obstaclesToRobot, PyArrayObject *__pyx_v_var, PyArrayObject *__pyx_v_beamParam); /* proto */
 ...
 * def state_refine(np.ndarray[double, ndim=1, mode="c"] optRobotSt not None, np.ndarray[double, ndim=2, mode="c"] obs not None, np.ndarray[double, ndim=2, mode="c"] mapMatrix not None,             # <<<<<<<<<<<<<<
 *     np.ndarray[double, ndim=1, mode="c"] robotState not None, np.ndarray[double, ndim=2, mode="c"] obstaclesToRobot not None,
 *     np.ndarray[double, ndim=1, mode="c"] var not None, np.ndarray[double, ndim=1, mode="c"] beamParam not None):
 */

/* Python wrapper */
static PyObject *__pyx_pw_12state_refine_1state_refine(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_12state_refine_1state_refine = {"state_refine", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_12state_refine_1state_refine, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_12state_refine_1state_refine(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_optRobotSt = 0;
  PyArrayObject *__pyx_v_obs = 0;
  PyArrayObject *__pyx_v_mapMatrix = 0;
  PyArrayObject *__pyx_v_robotState = 0;
  PyArrayObject *__pyx_v_obstaclesToRobot = 0;
  PyArrayObject *__pyx_v_var = 0;
  PyArrayObject *__pyx_v_beamParam = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("state_refine (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_optRobotSt,&__pyx_n_s_obs,&__pyx_n_s_mapMatrix,&__pyx_n_s_robotState,&__pyx_n_s_obstaclesToRobot,&__pyx_n_s_var,&__pyx_n_s_beamParam,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_optRobotSt)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_obs)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("state_refine", 1, 7, 7, 1); __PYX_ERR(0, 13, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_mapMatrix)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("state_refine", 1, 7, 7, 2); __PYX_ERR(0, 13, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_robotState)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("state_refine", 1, 7, 7, 3); __PYX_ERR(0, 13, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_obstaclesToRobot)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("state_refine", 1, 7, 7, 4); __PYX_ERR(0, 13, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_var)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("state_refine", 1, 7, 7, 5); __PYX_ERR(0, 13, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_beamParam)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("state_refine", 1, 7, 7, 6); __PYX_ERR(0, 13, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "state_refine") < 0)) __PYX_ERR(0, 13, __pyx_L3_error)
      }
    ...
    __pyx_v_optRobotSt = ((PyArrayObject *)values[0]);
    __pyx_v_obs = ((PyArrayObject *)values[1]);
    __pyx_v_mapMatrix = ((PyArrayObject *)values[2]);
    __pyx_v_robotState = ((PyArrayObject *)values[3]);
    __pyx_v_obstaclesToRobot = ((PyArrayObject *)values[4]);
    __pyx_v_var = ((PyArrayObject *)values[5]);
    __pyx_v_beamParam = ((PyArrayObject *)values[6]);
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("state_refine", 1, 7, 7, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 13, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("state_refine.state_refine", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_optRobotSt), __pyx_ptype_5numpy_ndarray, 0, "optRobotSt", 0))) __PYX_ERR(0, 13, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_obs), __pyx_ptype_5numpy_ndarray, 0, "obs", 0))) __PYX_ERR(0, 13, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_mapMatrix), __pyx_ptype_5numpy_ndarray, 0, "mapMatrix", 0))) __PYX_ERR(0, 13, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_robotState), __pyx_ptype_5numpy_ndarray, 0, "robotState", 0))) __PYX_ERR(0, 14, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_obstaclesToRobot), __pyx_ptype_5numpy_ndarray, 0, "obstaclesToRobot", 0))) __PYX_ERR(0, 14, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_var), __pyx_ptype_5numpy_ndarray, 0, "var", 0))) __PYX_ERR(0, 15, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_beamParam), __pyx_ptype_5numpy_ndarray, 0, "beamParam", 0))) __PYX_ERR(0, 15, __pyx_L1_error)
  __pyx_r = __pyx_pf_12state_refine_state_refine(__pyx_self, __pyx_v_optRobotSt, __pyx_v_obs, __pyx_v_mapMatrix, __pyx_v_robotState, __pyx_v_obstaclesToRobot, __pyx_v_var, __pyx_v_beamParam);
...
static PyObject *__pyx_pf_12state_refine_state_refine(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_optRobotSt, PyArrayObject *__pyx_v_obs, PyArrayObject *__pyx_v_mapMatrix, PyArrayObject *__pyx_v_robotState, PyArrayObject *__pyx_v_obstaclesToRobot, PyArrayObject *__pyx_v_var, PyArrayObject *__pyx_v_beamParam) {
  int __pyx_v_obsCnt;
  double __pyx_v_score;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_beamParam;
  __Pyx_Buffer __pyx_pybuffer_beamParam;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_mapMatrix;
  __Pyx_Buffer __pyx_pybuffer_mapMatrix;
  ...
  __Pyx_LocalBuf_ND __pyx_pybuffernd_optRobotSt;
  __Pyx_Buffer __pyx_pybuffer_optRobotSt;
  ...
  __Pyx_RefNannySetupContext("state_refine", 0);
  __pyx_pybuffer_optRobotSt.pybuffer.buf = NULL;
  __pyx_pybuffer_optRobotSt.refcount = 0;
  __pyx_pybuffernd_optRobotSt.data = NULL;
  __pyx_pybuffernd_optRobotSt.rcbuffer = &__pyx_pybuffer_optRobotSt;
  ...
  __pyx_pybuffer_mapMatrix.pybuffer.buf = NULL;
  __pyx_pybuffer_mapMatrix.refcount = 0;
  __pyx_pybuffernd_mapMatrix.data = NULL;
  __pyx_pybuffernd_mapMatrix.rcbuffer = &__pyx_pybuffer_mapMatrix;
  ...
  __pyx_pybuffer_beamParam.pybuffer.buf = NULL;
  __pyx_pybuffer_beamParam.refcount = 0;
  __pyx_pybuffernd_beamParam.data = NULL;
  __pyx_pybuffernd_beamParam.rcbuffer = &__pyx_pybuffer_beamParam;
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_optRobotSt.rcbuffer->pybuffer, (PyObject*)__pyx_v_optRobotSt, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 13, __pyx_L1_error)
  }
  __pyx_pybuffernd_optRobotSt.diminfo[0].strides = __pyx_pybuffernd_optRobotSt.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_optRobotSt.diminfo[0].shape = __pyx_pybuffernd_optRobotSt.rcbuffer->pybuffer.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_obs.rcbuffer->pybuffer, (PyObject*)__pyx_v_obs, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 13, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_mapMatrix.rcbuffer->pybuffer, (PyObject*)__pyx_v_mapMatrix, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 13, __pyx_L1_error)
  }
  __pyx_pybuffernd_mapMatrix.diminfo[0].strides = __pyx_pybuffernd_mapMatrix.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_mapMatrix.diminfo[0].shape = __pyx_pybuffernd_mapMatrix.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_mapMatrix.diminfo[1].strides = __pyx_pybuffernd_mapMatrix.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_mapMatrix.diminfo[1].shape = __pyx_pybuffernd_mapMatrix.rcbuffer->pybuffer.shape[1];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_robotState.rcbuffer->pybuffer, (PyObject*)__pyx_v_robotState, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 13, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_obstaclesToRobot.rcbuffer->pybuffer, (PyObject*)__pyx_v_obstaclesToRobot, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 13, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_var.rcbuffer->pybuffer, (PyObject*)__pyx_v_var, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 13, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_beamParam.rcbuffer->pybuffer, (PyObject*)__pyx_v_beamParam, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 13, __pyx_L1_error)
  }
  __pyx_pybuffernd_beamParam.diminfo[0].strides = __pyx_pybuffernd_beamParam.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_beamParam.diminfo[0].shape = __pyx_pybuffernd_beamParam.rcbuffer->pybuffer.shape[0];

  /* "state_refine.pyx":18
 * 
 *     cdef int obsCnt
 *     obsCnt = obstaclesToRobot.shape[0]             # <<<<<<<<<<<<<<
 *     score = c_state_refine (&optRobotSt[0], &obs[0, 0], &mapMatrix[0, 0], &robotState[0], &obstaclesToRobot[0, 0], &var[0], &beamParam[0], obsCnt)
 * 
 */
 ...
 */
  ...
  __pyx_t_9 = 0;
  __pyx_t_10 = 0;
  __pyx_v_score = c_state_refine((&(*__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_optRobotSt.rcbuffer->pybuffer.buf, __pyx_t_1, __pyx_pybuffernd_optRobotSt.diminfo[0].strides))), (&(*__Pyx_BufPtrCContig2d(double *, __pyx_pybuffernd_obs.rcbuffer->pybuffer.buf, __pyx_t_2, __pyx_pybuffernd_obs.diminfo[0].strides, __pyx_t_3, __pyx_pybuffernd_obs.diminfo[1].strides))), (&(*__Pyx_BufPtrCContig2d(double *, __pyx_pybuffernd_mapMatrix.rcbuffer->pybuffer.buf, __pyx_t_4, __pyx_pybuffernd_mapMatrix.diminfo[0].strides, __pyx_t_5, __pyx_pybuffernd_mapMatrix.diminfo[1].strides))), (&(*__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_robotState.rcbuffer->pybuffer.buf, __pyx_t_6, __pyx_pybuffernd_robotState.diminfo[0].strides))), (&(*__Pyx_BufPtrCContig2d(double *, __pyx_pybuffernd_obstaclesToRobot.rcbuffer->pybuffer.buf, __pyx_t_7, __pyx_pybuffernd_obstaclesToRobot.diminfo[0].strides, __pyx_t_8, __pyx_pybuffernd_obstaclesToRobot.diminfo[1].strides))), (&(*__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_var.rcbuffer->pybuffer.buf, __pyx_t_9, __pyx_pybuffernd_var.diminfo[0].strides))), (&(*__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_beamParam.rcbuffer->pybuffer.buf, __pyx_t_10, __pyx_pybuffernd_beamParam.diminfo[0].strides))), __pyx_v_obsCnt);
 ...
 */
  ...
  __pyx_t_11 = PyFloat_FromDouble(__pyx_v_score); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 21, __pyx_L1_error)
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_beamParam.rcbuffer->pybuffer);
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_mapMatrix.rcbuffer->pybuffer);
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_optRobotSt.rcbuffer->pybuffer);
...
static int __pyx_pymod_exec_state_refine(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_state_refine},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_beamParam, __pyx_k_beamParam, sizeof(__pyx_k_beamParam), 0, 0, 1, 1},
  {&__pyx_n_s_cline_in_traceback, __pyx_k_cline_in_traceback, sizeof(__pyx_k_cline_in_traceback), 0, 0, 1, 1},
  {&__pyx_n_s_import, __pyx_k_import, sizeof(__pyx_k_import), 0, 0, 1, 1},
  {&__pyx_n_s_main, __pyx_k_main, sizeof(__pyx_k_main), 0, 0, 1, 1},
  {&__pyx_n_s_mapMatrix, __pyx_k_mapMatrix, sizeof(__pyx_k_mapMatrix), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_obsCnt, __pyx_k_obsCnt, sizeof(__pyx_k_obsCnt), 0, 0, 1, 1},
  {&__pyx_n_s_obstaclesToRobot, __pyx_k_obstaclesToRobot, sizeof(__pyx_k_obstaclesToRobot), 0, 0, 1, 1},
  {&__pyx_n_s_optRobotSt, __pyx_k_optRobotSt, sizeof(__pyx_k_optRobotSt), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_state_refine, __pyx_k_state_refine, sizeof(__pyx_k_state_refine), 0, 0, 1, 1},
  {&__pyx_kp_s_state_refine_pyx, __pyx_k_state_refine_pyx, sizeof(__pyx_k_state_refine_pyx), 0, 0, 1, 0},
 ...
 *     np.ndarray[double, ndim=1, mode="c"] var not None, np.ndarray[double, ndim=1, mode="c"] beamParam not None):
 */
  __pyx_tuple__8 = PyTuple_Pack(9, __pyx_n_s_optRobotSt, __pyx_n_s_obs, __pyx_n_s_mapMatrix, __pyx_n_s_robotState, __pyx_n_s_obstaclesToRobot, __pyx_n_s_var, __pyx_n_s_beamParam, __pyx_n_s_obsCnt, __pyx_n_s_score); if (unlikely(!__pyx_tuple__8)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__8);
  __Pyx_GIVEREF(__pyx_tuple__8);
  __pyx_codeobj__9 = (PyObject*)__Pyx_PyCode_New(7, 0, 9, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__8, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_state_refine_pyx, __pyx_n_s_state_refine, 13, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__9)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initstate_refine(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initstate_refine(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_state_refine(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_state_refine(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_state_refine(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'state_refine' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_state_refine(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("state_refine", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_state_refine) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "state_refine")) {
      if (unlikely(PyDict_SetItemString(modules, "state_refine", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     np.ndarray[double, ndim=1, mode="c"] var not None, np.ndarray[double, ndim=1, mode="c"] beamParam not None):
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_12state_refine_1state_refine, NULL, __pyx_n_s_state_refine); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_state_refine, __pyx_t_1) < 0) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init state_refine", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init state_refine");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
